        ...
        <div className="wrapper">
          <div className="form__box">
            <form onSubmit={handleSubmit} className="form" action="#" >
              <img className={`icon ${hideIcon ? "hide" : ""}`} src={success} alt="success" />
              <h1>{headerText}</h1>
              <div className="form__text">{text}</div>

              <div className={`form-email ${hideIcon ? "" : "hide"}`} >
                <input 
                value={values.email} 
                onChange={handleChange}
                onBlur={handleBlur}
                className="form__inputstyle"
                 placeholder="Type your email address here..."  name="email" id="email" type="email" />
                {touched.email && errors.email && (
                <span className="errorText">{errors.email}</span>
                )}
                <span className="beforeelem"></span>
                

                <button disabled={isSubmitting} type="submit" className="button"><svg width="24" height="14" viewBox="0 0 24 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className={`form__policy ${hideIcon ? "" : "hide"}`} >
                <input  
                value={values.checkbox} 
                onChange={handleChange}
                onBlur={handleBlur}
                  className="form__checkbox" name="checkbox" id="checkbox"  type="checkbox" />
                {touched.checkbox && errors.checkbox && (
                <span className="errorTextCheck">{errors.checkbox}</span>
                )}
          ...
          <div className="form__wrapper-bottom">
            ...
            <div className="form__links">
              ...
              <div className="form__linkbox instagemhover "><a href="#" className="form__link "><svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <div className="form__linkbox twitterhover "><a href="#" className="form__link "><svg width="16" height="13" viewBox="0 0 16 13" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <div className="form__linkbox youtubehover "><a href="#" className="form__link "><svg width="16" height="11" viewBox="0 0 16 11" fill="none" xmlns="http://www.w3.org/2000/svg">
