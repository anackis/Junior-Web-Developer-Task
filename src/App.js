  ...
  const formik = useFormik({
    ...
    validationSchema: Yup.object({
        email: Yup.string()
                ...
                .matches(/^((?!.co$).)*$/ , 'We are not accepting subscriptions from Colombia emails')
                .email('Invalid Email !'),
        terms: Yup.boolean()
...
return (
  <section className="main" id="main-id">
    <div className="main__left">

      <header className="header">
        <div className="header__logo"><a href="#"><img src={logo} alt="logo_img"></img></a></div>
        <div className="header__logomobile"><a href="#"><img src={mobilelogo} alt="logo_img"></img></a></div>
      ...
      <div className="wrapper">
        <div className="form__box">
          <form onSubmit={formik.handleSubmit} className="form" action="#" >
            ...
            <img className={hideIcon ? "icon hide" : "icon"} src={success} alt="success" />
            <h1 className={hideIcon ? "" : "h1-px-error"}>{headerText}</h1>
            <div className="form__text">{text}</div>
            <div className={hideIcon ? "form-email" : "form-email hide"} >
              <input
                id="email"
                name="email"
                type="email"
                ...
                className={formik.errors.email && formik.touched.email ? "form__inputstyle-error form__inputstyle" : "form__inputstyle"}
                placeholder="Type your email address here..."
              />
              {formik.errors.email && formik.touched.email ? <div className="errorText">{formik.errors.email}</div> : null}
              <span className={formik.errors.email && formik.touched.email ? "beforeelem-error beforeelem" : "beforeelem"}></span>
              <button type="submit" className="button">
                <svg width="24" height="14" viewBox="0 0 24 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path className="button-path" opacity="0.3" d="M17.7071 0.2929C17.3166 -0.0976334 16.6834 -0.0976334 16.2929 0.2929C15.9023 0.683403 15.9023 1.31658 16.2929 1.70708L20.5858 5.99999H1C0.447693 5.99999 0 6.44772 0 6.99999C0 7.55227 0.447693 7.99999 1 7.99999H20.5858L16.2929 12.2929C15.9023 12.6834 15.9023 13.3166 16.2929 13.7071C16.6834 14.0976 17.3166 14.0976 17.7071 13.7071L23.7071 7.70708C24.0977 7.31658 24.0977 6.6834 23.7071 6.2929L17.7071 0.2929Z" fill="#131821"/>
                </svg>
              </button> 
            </div>

            <div className={hideIcon ? "form__policy" : "form__policy hide"}>
              <input 
                id="checkbox"
                name="terms" 
                type="checkbox" 
              ...
              />
              {formik.errors.terms && formik.touched.terms ? <div className="errorTextCheck">{formik.errors.terms}</div> : null}
              <div className="form__spanwrapper">
                <span>I agree to </span>
                <a href="#" className="form__policylink">terms of service</a>
              </div>
            </div>
        ...
        <footer className="form__wrapper-bottom">
          <div className="form__line"></div>
          <div className="form__links">
            <div className="form__linkbox facebookhover "><a href="#" className="form__link "><svg width="8" height="16" viewBox="0 0 8 16" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="form__linkbox instagemhover ">
              <a href="#" className="form__link "><svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="form__linkbox twitterhover ">
              <a href="#" className="form__link "><svg width="16" height="13" viewBox="0 0 16 13" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="form__linkbox youtubehover ">
              <a href="#" className="form__link form__link-pixelerror"><svg width="16" height="11" viewBox="0 0 16 11" fill="none" xmlns="http://www.w3.org/2000/svg">
